...
const CursorBurst = () => {
  useEffect(() => {
    ...
    const onBurstEvent = (e) => {
      onClick({ clientX: e.detail.x, clientY: e.detail.y });
    };

    window.addEventListener("mousemove", onMouseMove);
    window.addEventListener("cursor-burst", onBurstEvent);
    animateTrail();

    return () => {
      window.removeEventListener("mousemove", onMouseMove);
      window.removeEventListener("cursor-burst", onBurstEvent);
