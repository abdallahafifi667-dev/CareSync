            ...
            conversations.map((convo) => {
              ...
              return (
                <div
                  ...
                  className={`flex items-center p-4 cursor-pointer transition-colors ${activeConversation?._id === convo._id
                        ...
                        {messages.length > 0 ? (
                          messages.map((msg) => (
                            ...
                            >
                              ...
                              <div
                                className={`max-w-md p-3 rounded-2xl ${msg.sender._id === user._id
                                    ? 'bg-primary-600 text-white rounded-br-none'
                                    : 'bg-gray-200 dark:bg-gray-700 text-gray-900 dark:text-gray-100 rounded-bl-none'
                                  }`}
                              >
                                <p>{msg.content}</p>
                                <span className={`text-xs mt-1 block text-right ${msg.sender._id === user._id ? 'text-blue-200' : 'text-gray-500 dark:text-gray-400'
                                  }`}>
