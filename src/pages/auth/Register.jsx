...
import { COUNTRY_CODES } from '../../shared/data/dummyData'
              ...
              <div>
                <div className="relative">
                  ...
                  <motion.input
                    ...
                    className={`block w-full pl-12 pr-12 py-3 border rounded-xl text-gray-900 dark:text-gray-100 placeholder-gray-500 dark:placeholder-gray-400 focus:outline-none focus:ring-2 transition-all duration-200 bg-white/70 dark:bg-gray-700/50 hover:bg-white dark:hover:bg-gray-700 ${errors.confirmPassword ? "border-red-500 focus:ring-red-500" : "border-gray-300 dark:border-gray-600 focus:ring-emerald-500 dark:focus:ring-emerald-400 focus:border-emerald-500"
                      }`}
                    whileFocus={{ scale: 1.02 }}
